...
from dictionaries.category.views import (CategoriesListView, CategoriesCreateView,
...
urlpatterns = [
    ...
    url(
        r'^(?P<category>[-\w]+)/edit/$',
        CategoriesUpdateView.as_view(),
        name='categories-edit'
    ),
    url(
        r'^(?P<category>[-\w]+)/delete/$',
        CategoriesDeleteView.as_view(),
        name='categories-delete'
    ),
    url(
        r'^(?P<category>[-\w]+)/types/',
        include('dictionaries.type.urls')
    ),
