...
В категории «Образование» представлены следующие справочники
...
* :ref:`dict-institutions-label` - в справочнике настраиваются учреждения по которым ведется учёт.
...
Изначально заполнен списком с первого по одиннадцатый классы.
...
Справочник пред заполнен следующими записями
...
В справочник заносятся учреждения по которым ведется учёт детей.
...
В категории «Адреса» представлены следующие справочники
...
В категории «Дополнительные» представлены следующие справочники
...
Рассмотрим основной общий принцип работы с любым справочником на примере справочника «Классы», т.к. для других справочников будет все аналогично.
...
Что бы редактировать запись в справочнике, нажимаем на соответствующую запись в нем. Попадаем на страницу записи, в которой для редактирования записи нажимаем кнопу «Редактировать».
